...
const dict = {
  en: {
    ...
    "form.remove": "Remove",
    "form.upload": "Upload",
    "form.fromUrl": "From link",
    "form.urlPlaceholder": "https://example.com/image.jpg",
    "form.addUrl": "Add link",
    "form.err.url": "Enter a valid image link (http or https).",
    ...
    "shopping.nav": "Shopping list",
    "shopping.add": "Add item",
    "shopping.adding": "Adding…",
    "shopping.name": "Item",
    "shopping.namePlaceholder": "e.g. Navy linen, 2m",
    "shopping.quantity": "Quantity",
    "shopping.quantityPlaceholder": "e.g. 2 m",
    "shopping.notes": "Notes",
    "shopping.notesPlaceholder": "Shop, price, colour…",
    "shopping.project": "Project",
    "shopping.noProject": "No project",
    "shopping.allProjects": "All projects",
    "shopping.toBuy": "To buy",
    "shopping.bought": "Bought",
    "shopping.empty": "Nothing on your list yet.",
    "shopping.emptyFilter": "No items for this filter.",
    "shopping.err.name": "An item name is required.",
    "shopping.added": "Item added",
    "shopping.updated": "Item updated",
    "shopping.deleted": "Item removed",
    ...
    //"measure.units": "Angles in degrees",
    "measure.unitCm": "cm",
    "measure.unitIn": "in",
    "measure.unitToggle": "Switch unit",
  ...
  it: {
    ...
    "form.remove": "Rimuovi",
    "form.upload": "Carica",
    "form.fromUrl": "Da link",
    "form.urlPlaceholder": "https://esempio.com/immagine.jpg",
    "form.addUrl": "Aggiungi link",
    "form.err.url": "Inserisci un link immagine valido (http o https).",
    ...
    "shopping.nav": "Lista della spesa",
    "shopping.add": "Aggiungi articolo",
    "shopping.adding": "Aggiunta…",
    "shopping.name": "Articolo",
    "shopping.namePlaceholder": "es. Lino blu, 2m",
    "shopping.quantity": "Quantità",
    "shopping.quantityPlaceholder": "es. 2 m",
    "shopping.notes": "Note",
    "shopping.notesPlaceholder": "Negozio, prezzo, colore…",
    "shopping.project": "Progetto",
    "shopping.noProject": "Nessun progetto",
    "shopping.allProjects": "Tutti i progetti",
    "shopping.toBuy": "Da comprare",
    "shopping.bought": "Comprati",
    "shopping.empty": "La tua lista è vuota.",
    "shopping.emptyFilter": "Nessun articolo per questo filtro.",
    "shopping.err.name": "Il nome dell'articolo è obbligatorio.",
    "shopping.added": "Articolo aggiunto",
    "shopping.updated": "Articolo aggiornato",
    "shopping.deleted": "Articolo rimosso",
    "shopping.markBought": "Segna come comprato",
    ...
    //"measure.units": "Angoli in gradi",
    "measure.unitCm": "cm",
    "measure.unitIn": "in",
    "measure.unitToggle": "Cambia unità",
